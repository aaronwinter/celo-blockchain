...
[`accounts.Manager`](https://godoc.org/github.com/aaronwinter/celo-blockchain/accounts#Manager)
struct from the
[`github.com/aaronwinter/celo-blockchain/accounts`](https://godoc.org/github.com/aaronwinter/celo-blockchain/accounts)
...
```go
import "github.com/aaronwinter/celo-blockchain/accounts"
```
...
[`accounts.NewManager`](https://godoc.org/github.com/aaronwinter/celo-blockchain/accounts#NewManager)
...
accounts.LightScryptP`](https://godoc.org/github.com/aaronwinter/celo-blockchain/accounts#pkg-constants)
...
[`accounts.Account`](https://godoc.org/github.com/aaronwinter/celo-blockchain/accounts#Account)
struct from the
[`github.com/aaronwinter/celo-blockchain/accounts`](https://godoc.org/github.com/aaronwinter/celo-blockchain/accounts)
...
[`NewAccount`](https://godoc.org/github.com/aaronwinter/celo-blockchain/accounts#Manager.NewAccount)
method; and to avoid going into transaction creation for now, we can hard-code a random
[`common.Hash`](https://godoc.org/github.com/aaronwinter/celo-blockchain/common#Hash) to sign
instead.
...
You may wonder why
[`SignWithPassphrase`](https://godoc.org/github.com/aaronwinter/celo-blockchain/accounts#Manager.SignWithPassphrase)
takes an
[`accounts.Account`](https://godoc.org/github.com/aaronwinter/celo-blockchain/accounts#Account)
as the signer, whereas
[`Sign`](https://godoc.org/github.com/aaronwinter/celo-blockchain/accounts#Manager.Sign) takes
only a
[`common.Address`](https://godoc.org/github.com/aaronwinter/celo-blockchain/common#Address). The
reason is that an
[`accounts.Account`](https://godoc.org/github.com/aaronwinter/celo-blockchain/accounts#Account)
object may also contain a custom key-path, allowing
[`SignWithPassphrase`](https://godoc.org/github.com/aaronwinter/celo-blockchain/accounts#Manager.SignWithPassphrase)
to sign using accounts outside of the keystore; however
[`Sign`](https://godoc.org/github.com/aaronwinter/celo-blockchain/accounts#Manager.Sign) relies
