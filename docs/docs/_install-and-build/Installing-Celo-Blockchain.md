...
We provide archives containing only Geth, and archives containing Geth along with the developer tools from our repository (`abigen`, `bootnode`, `disasm`, `evm`, `rlpdump`). Read our [`README`](https://github.com/aaronwinter/celo-blockchain#executables) for more information about these executables.
...
Or you can build the entire project and install `geth` along with all developer tools by running `go install ./...` in the `aaronwinter/celo-blockchain` repository root inside your `GOPATH` workspace.
...
C:\Users\xxx> git clone https://github.com/aaronwinter/celo-blockchain src\github.com\ethereum\go-ethereum
...
```shell
git clone https://github.com/aaronwinter/celo-blockchain
```
