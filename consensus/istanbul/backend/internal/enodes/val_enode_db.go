...
import (
	...
	"github.com/aaronwinter/celo-blockchain/consensus/istanbul/backend/internal/db"
...
//        should be managed be a separate thread (see https://github.com/aaronwinter/celo-blockchain/issues/607)
