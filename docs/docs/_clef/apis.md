...
* Changelog for [External API](https://github.com/aaronwinter/celo-blockchain/blob/master/cmd/clef/extapi_changelog.md)
* Changelog for [UI API](https://github.com/aaronwinter/celo-blockchain/blob/master/cmd/clef/intapi_changelog.md)
* Documentation about [Datatypes](datatypes)


## External API

See the [external api changelog](https://github.com/aaronwinter/celo-blockchain/blob/master/cmd/clef/extapi_changelog.md) for information about changes to this API.
...
See the [ui api changelog](https://github.com/aaronwinter/celo-blockchain/blob/master/cmd/clef/intapi_changelog.md) for information about changes to this API.
