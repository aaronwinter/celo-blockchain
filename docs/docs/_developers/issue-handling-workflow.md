...
Have 50 issues labelled [help wanted](https://github.com/aaronwinter/celo-blockchain/labels/help%20wanted) and 50 [good first issue](https://github.com/aaronwinter/celo-blockchain/labels/good%20first%20issue).
...
- [Future](https://github.com/aaronwinter/celo-blockchain/milestone/80) - Maybe implement one day
- [Coming soon](https://github.com/aaronwinter/celo-blockchain/milestone/81) - Not assigned to a specific release, but to be delivered in one of the upcoming releases
...
## Workflow
We have a weekly or bi-weekly triage meeting. Issues are preselected by [labelling them "status:triage" and sorted the oldest ones first](https://github.com/aaronwinter/celo-blockchain/issues?q=is%3Aopen+is%3Aissue+label%3Astatus%3Atriage+sort%3Acreated-asc). This is when we go through the new issues and do one of the following
1. Close it.
